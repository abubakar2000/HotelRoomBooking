...
const RoomDetail = ({ navigation }) => {
  return (
    <View>
      ...
      <View style={{ flexDirection: 'row',position:'absolute',bottom:0,width:'100%',backgroundColor:'white' }}>
        <TouchableOpacity style={{ flex: 1, minHeight: 65, justifyContent: 'center', alignItems: 'center' }}>
          <View style={{
            borderColor: 'rgb(220,220,220)', borderWidth: 1, borderRadius: 30, height: 50, width: '95%',
